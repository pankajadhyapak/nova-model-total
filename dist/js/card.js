...
Nova.booting(function (Vue, router) {
    Vue.component('modelTotal', __webpack_require__(2));
});
...
var render = function() {
  ...
  return _c(
    "card",
    { staticClass: "card relative metric px-6 py-4 relative card-panel" },
    [
      _c("div", { staticClass: "flex mb-4" }, [
        _c("h3", { staticClass: "mr-3 text-base text-80 font-bold" }, [
          _vm._v(
            "\n            " + _vm._s(_vm.card.display_name) + "\n        "
          )
        ])
      ]),
      _vm._v(" "),
      _c("p", { staticClass: "flex items-center text-4xl mb-4" }, [
        _vm._v(
          "\n        " + _vm._s(_vm.card.total.toLocaleString()) + "\n    "
        )
      ])
    ]
  )
